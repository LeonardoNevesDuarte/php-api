        ...
        if(isset($json_obj["authKey"])) {
            ...
            if(true) {
                ...
                if(count($json_obj["param"]) != 3) {
                    //Bad request
                    $json_output = str_replace('__RESULT__', '"Parametros invalidos. Utilizar: Valor Futuro, Tx. Juros, Periodos"', $JSONStandard[4]);
                } else {
